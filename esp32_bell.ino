...
// --- KONFIGURASI WIFI ---
const char* ssid = "Office-SMG";
const char* password = "passwordapa";

// --- URL API SERVER ---
const char* serverCheckUrl = "https://sm-group.co.id/office/bell/check_bell.php";
const char* serverLogUrl   = "https://sm-group.co.id/office/bell/log_bell.php";
